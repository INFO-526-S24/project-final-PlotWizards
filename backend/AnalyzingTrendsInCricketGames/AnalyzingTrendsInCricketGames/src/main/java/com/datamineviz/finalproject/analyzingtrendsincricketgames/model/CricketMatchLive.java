...
public class CricketMatchLive {
	 ...
	 private long matchId;
		...
		public CricketMatchLive(long matchId, String season, String venue, int innings, float ball, String battingTeam,
				...
				String playerOfMatch, long id, int totalRuns) {
			super();
		...
		public CricketMatchLive(CricketMatch2023 entry, int totalRuns) {
			super();
